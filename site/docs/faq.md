...
Only what you allow. The safe model is explicit owner lock plus deliberate permissions and clear pauses before risky actions.
...
### Why WhatsApp at all?
Because it's already where people live. Wira removes the friction of learning a new interface first. You start from your phone, then grow into richer local-agent use later.
...
- real local runtime bridge
- discoverable advanced handoff
